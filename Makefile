...
LFLAGS_STM32=$(LFLAGS) $(SRC_FILES)/main.c -T memory.x
...
$(OUTPUT_DIR)/stm32/bluepill.elf: $(SRC_FILES)/main.c libopencm3/lib/libopencm3_stm32f1.a
...
flash:
	openocd -f interface/stlink-v2.cfg -f target/stm32f1x.cfg -c "program out/stm32/bluepill.elf verify reset exit"
